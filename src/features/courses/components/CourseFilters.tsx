    ...
    <div className="w-full h-28 p-8">
      <div className="relative flex items-center w-72">
        ...
        <input
          ...
          className="w-full h-12 bg-gray-button text-gray-custom pl-11 pr-4 rounded-lg outline-none"
        />
      </div>
      ...
      <div className="flex items-center gap-8 pt-6">
        <div className="relative">
          <select
            ...
            className="appearance-none bg-white text-sm text-gray-custom border border-gray-bord rounded-lg pl-4 pr-10 py-2 outline-none cursor-pointer w-56"
          >
