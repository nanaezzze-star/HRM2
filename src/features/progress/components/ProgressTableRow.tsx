...
import { formatDate, formatTime } from "@/shared/lib/formatter";
...
export function ProgressTableRow({ employee }: TableRowProps) {
                    ...
                    <div className="col-span-2 flex items-baseline gap-1 ">
                      {time ? (
                        <>
                          ...
                          <span className="text-xs font-normal text-gray-custom mr-1">
                            min
                          </span>
                          <span className="text-sm font-normal text-dark">
                            {time.secs}
                          </span>
                          <span className="text-xs font-normal text-gray-custom">
                            sec
                          </span>
                        </>
                      ) : (
                        <span className="text-sm text-gray-custom">-</span>
                      )}
                    </div>
