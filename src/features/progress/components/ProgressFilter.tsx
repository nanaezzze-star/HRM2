      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
        <div className="relative w-full md:w-72">
          ...
          <input
            ...
            pl-10 pr-4 rounded-lg outline-none border border-transparent focus:border-gray-200 transition-colors"
          />
        </div>
      ...
      <div className="flex flex-wrap items-center gap-3 md:gap-4">
        <div className="relative w-full md:w-auto">
          <select
            ...
            className="appearance-none bg-white text-sm text-gray-custom 
            border border-gray-button rounded-lg pl-3 pr-8 py-2 outline-none 
            cursor-pointer w-full md:min-w-[180px]"
          >
        ...
        <button
          type="button"
          className="flex items-center gap-1.5 text-sm text-gray-custom 
          border border-gray-button rounded-lg px-3 py-2"
        >
          <span>More</span>
